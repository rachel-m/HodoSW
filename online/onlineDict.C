...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::OnlineGUI*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("OnlineGUI", "online.h", 113,
...
"/mnt/share/cern_CentOS7/root/v6.20.04/include/",
"/home/rachel/sbs-offline/OnlineDisplay/HodoOnline/",
0
    };
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("onlineDict",
        ...
        TriggerDictionaryInitialization_onlineDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
